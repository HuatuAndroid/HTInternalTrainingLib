        ...
        if (position>1){
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ToastUtils.showToast(context,"评论详情");
...
//        String content = "<font color=\"#FE6026\">" + ""+parentBean. + "</font>"
            holder.tvTitle.setText(parentBean.content);
            ...
            holder.ivDel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ToastUtils.showToast(context,"删除："+parentBean.userName);
                }
            });
