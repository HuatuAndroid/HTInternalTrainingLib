...
public class LocalImageHelper {
    ...
    public String setCameraImgPath() {
        String foloder= AppUtils.getCachePath()
                + "/PostPicture/";
    ...
    private String getThumbnail(int id, String path) {
        try {
            ...
            Cursor cursor = context.getContentResolver().query(MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI,
                    ...
                    null);
            //10 修复加载本地图片库崩溃问题
            //[lfd][um-crash-fix][23/03/17][start][http://mobile.umeng.com/apps/a69100ae0fa55f0ef2007c65/error_types/show?error_type_id=56c7002fe0f55af0ea00196a_1454713335950065995_2.7.1]
            if(cursor == null){
                return null;
            }
            //[lfd][um-crash-fix][23/03/17][end][]
