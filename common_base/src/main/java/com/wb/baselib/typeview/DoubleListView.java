...
public class DoubleListView<LEFTD, RIGHTD> extends LinearLayout implements AdapterView.OnItemClickListener {
    ...
    private ListBaseAdapter<LEFTD> mLeftAdapter;
    private ListBaseAdapter<RIGHTD> mRightAdapter;
    ...
    public DoubleListView<LEFTD, RIGHTD> leftAdapter(Simple1TextAdapter<LEFTD> leftAdapter) {
