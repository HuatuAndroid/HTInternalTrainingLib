...
/**
 * A TitlePageIndicator is a PageIndicator which displays the title of left com.jungan.www.module_public.com.jungan.www.module_usering.view
 * (if exist), the title of the current select com.jungan.www.module_public.com.jungan.www.module_usering.view (centered) and the title of
 * the right com.jungan.www.module_public.com.jungan.www.module_usering.view (if exist). When the user scrolls the ViewPager then titles are
 * also scrolled.
 */
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    /**
     * Title text used when no title is provided by the com.jungan.www.module_public.com.jungan.www.module_usering.adapter.
     */
    ...
    /** Left and right side padding for not active com.jungan.www.module_public.com.jungan.www.module_usering.view titles. */
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        //Retrieve the colors to be used for this com.jungan.www.module_public.com.jungan.www.module_usering.view and apply them.
     ...
     * (non-Javadoc)
     *
     * @see android.com.jungan.www.module_public.com.jungan.www.module_usering.view.View#onDraw(android.graphics.Canvas)
     */
    @Override
    protected void onDraw(Canvas canvas) {
        ...
        //Verify if the current com.jungan.www.module_public.com.jungan.www.module_usering.view must be clipped to the screen
        ...
        if (mCurrentPage > 0) {
            for (int i = mCurrentPage - 1; i >= 0; i--) {
                ...
                if (bound.left < leftClip) {
                    ...
                    //Except if there's an intersection with the right com.jungan.www.module_public.com.jungan.www.module_usering.view
        ...
        if (mCurrentPage < countMinusOne) {
            for (int i = mCurrentPage + 1 ; i < count; i++) {
                ...
                if (bound.right > rightClip) {
                    ...
                    //Except if there's an intersection with the left com.jungan.www.module_public.com.jungan.www.module_usering.view
     ...
     *            current bounds.
     * @param curViewWidth
     *            width of the com.jungan.www.module_public.com.jungan.www.module_usering.view.
     */
    ...
    /**
     * Calculate the bounds for a com.jungan.www.module_public.com.jungan.www.module_usering.view's title
     *
     * @param index
     * @param paint
     * @return
    ...
    public void setViewPager(ViewPager view) {
        ...
        if (view.getAdapter() == null) {
            throw new IllegalStateException("ViewPager does not have com.jungan.www.module_public.com.jungan.www.module_usering.adapter instance.");
        }
        mViewPager = view;
