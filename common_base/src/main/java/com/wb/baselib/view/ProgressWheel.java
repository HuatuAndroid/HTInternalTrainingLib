...
public class ProgressWheel extends View {
  ...
  /**
   * Use onSizeChanged instead of onAttachedToWindow to get the dimensions of the com.jungan.www.module_public.view,
  ...
  /**
   * Parse the attributes passed to the com.jungan.www.module_public.view from the XML
   *
  ...
  /**
   * Puts the com.jungan.www.module_public.view on spin mode
   */
  public void spin() {
    lastTimeAnimated = SystemClock.uptimeMillis();
    isSpinning = true;
  ...
  // Great way to save a com.jungan.www.module_public.view's state http://stackoverflow.com/a/7089687/1991053
  @Override
