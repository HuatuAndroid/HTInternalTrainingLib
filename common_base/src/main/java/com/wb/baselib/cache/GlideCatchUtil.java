...
//        try {
//            return getFormatSize(getFolderSize(new File(mContext.getCacheDir() + "/" + AppConfigManager.newInstance().getAppConfig().getGlidePath())));
//        } catch (Exception e) {
//            e.printStackTrace();
//            return "获取失败";
//        }
...
//        return deleteFolderFile(mContext.getCacheDir() + "/" + AppConfigManager.newInstance().getAppConfig().getGlidePath(), true);
//    }
//
