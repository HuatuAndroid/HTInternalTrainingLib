package com.wangbo.smartrefresh.layout;
...
import com.wangbo.smartrefresh.layout.R;
import com.wangbo.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.wangbo.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.wangbo.smartrefresh.layout.api.RefreshContent;
import com.wangbo.smartrefresh.layout.api.RefreshFooter;
import com.wangbo.smartrefresh.layout.api.RefreshHeader;
import com.wangbo.smartrefresh.layout.api.RefreshInternal;
import com.wangbo.smartrefresh.layout.api.RefreshKernel;
import com.wangbo.smartrefresh.layout.api.RefreshLayout;
import com.wangbo.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.wangbo.smartrefresh.layout.constant.DimensionStatus;
import com.wangbo.smartrefresh.layout.constant.RefreshState;
import com.wangbo.smartrefresh.layout.constant.SpinnerStyle;
import com.wangbo.smartrefresh.layout.footer.BallPulseFooter;
import com.wangbo.smartrefresh.layout.header.BezierRadarHeader;
import com.wangbo.smartrefresh.layout.impl.RefreshContentWrapper;
import com.wangbo.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.wangbo.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.wangbo.smartrefresh.layout.listener.OnLoadMoreListener;
import com.wangbo.smartrefresh.layout.listener.OnMultiPurposeListener;
...
import com.wangbo.smartrefresh.layout.listener.OnStateChangedListener;
import com.wangbo.smartrefresh.layout.util.DelayedRunnable;
import com.wangbo.smartrefresh.layout.util.DensityUtil;
import com.wangbo.smartrefresh.layout.util.ScrollBoundaryUtil;
import com.wangbo.smartrefresh.layout.util.ViscousFluidInterpolator;
import com.wangbo.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter;
import com.wangbo.smartrefresh.layout.listener.SimpleMultiPurposeListener;
import com.wangbo.smartrefresh.layout.util.SmartUtil;
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < count; i++) {
            View view = super.getChildAt(i);
             if (SmartUtil.isScrollableView(view) && (contentLevel < 2 || i == 1)) {
                indexContent = i;
                contentLevel = 2;
...
//    }
    ...
    public SmartRefreshLayout setFooterHeight(float heightDp) {
        if (mFooterHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
            mFooterHeight = DensityUtil.dp2px(heightDp);
//            mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
...
//    }
    ...
    public SmartRefreshLayout setHeaderHeight(float heightDp) {
        if (mHeaderHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
            mHeaderHeight = DensityUtil.dp2px(heightDp);
//            mHeaderExtendHeight = (int) Math.max((mHeaderHeight * (mHeaderMaxDragRate - 1)), 0);
...
//    }
    ...
    public SmartRefreshLayout setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = DensityUtil.dp2px(insetDp);
        return this;
...
//    }
    ...
    public SmartRefreshLayout setFooterInsetStart(float insetDp) {
        mFooterInsetStart = DensityUtil.dp2px(insetDp);
        return this;
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    public SmartRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
        ...
        for (int i = 0; i < primaryColorId.length; i++) {
            colors[i] = SmartUtil.getColor(thisView.getContext(), primaryColorId[i]);
        }
