package com.wangbo.smartrefresh.layout.header;
...
import com.wangbo.smartrefresh.layout.api.OnTwoLevelListener;
...
import com.wangbo.smartrefresh.layout.internal.InternalAbstract;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static android.view.ViewGroup.LayoutParams.WRAP_CONTENT;
import static com.wangbo.smartrefresh.layout.constant.SpinnerStyle.*;
...
//    }
    ...
    public void onInitialized(@NonNull RefreshKernel kernel, int height, int maxDragHeight) {
        ...
        if (!thisView.isInEditMode() && mRefreshHeader.getSpinnerStyle() == Translate
                && mRefreshKernel == null) {
...
//    }
    ...
    public TwoLevelHeader setRefreshHeader(RefreshHeader header, int width, int height) {
        ...
        if (header != null) {
            ...
            if (header.getSpinnerStyle() == FixedBehind) {
