...
public class RightMenuPresenter implements RightMenuContract.Presenter {
    ...
    private Subscription subscriptionOfMediaControl, subscriptionOfClassEnd, subscriptionOfSpeakApplyResponse,
            subscriptionOfSpeakInvite, subscriptionOfClassStart;
