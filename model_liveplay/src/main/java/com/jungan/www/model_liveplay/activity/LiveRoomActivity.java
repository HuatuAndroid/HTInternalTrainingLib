package com.jungan.www.model_liveplay.activity;
...
import com.jungan.www.model_liveplay.LiveSDKWithUI;
import com.jungan.www.model_liveplay.R;
import com.jungan.www.model_liveplay.activity.LiveRoomBaseActivity;
import com.jungan.www.model_liveplay.activity.LiveRoomRouterListener;
import com.jungan.www.model_liveplay.announcement.AnnouncementFragment;
import com.jungan.www.model_liveplay.announcement.AnnouncementPresenter;
import com.jungan.www.model_liveplay.base.BasePresenter;
import com.jungan.www.model_liveplay.base.BaseView;
import com.jungan.www.model_liveplay.chat.ChatFragment;
import com.jungan.www.model_liveplay.chat.ChatPresenter;
import com.jungan.www.model_liveplay.chat.MessageSendPresenter;
import com.jungan.www.model_liveplay.chat.MessageSentFragment;
import com.jungan.www.model_liveplay.chat.preview.ChatPictureViewFragment;
import com.jungan.www.model_liveplay.chat.preview.ChatPictureViewPresenter;
import com.jungan.www.model_liveplay.chat.preview.ChatSavePicDialogFragment;
import com.jungan.www.model_liveplay.chat.preview.ChatSavePicDialogPresenter;
import com.jungan.www.model_liveplay.cloudrecord.CloudRecordFragment;
import com.jungan.www.model_liveplay.cloudrecord.CloudRecordPresenter;
import com.jungan.www.model_liveplay.error.ErrorFragment;
import com.jungan.www.model_liveplay.leftmenu.LeftMenuFragment;
import com.jungan.www.model_liveplay.leftmenu.LeftMenuPresenter;
import com.jungan.www.model_liveplay.loading.LoadingFragment;
import com.jungan.www.model_liveplay.loading.LoadingPresenter;
import com.jungan.www.model_liveplay.more.MoreMenuDialogFragment;
import com.jungan.www.model_liveplay.more.MoreMenuPresenter;
import com.jungan.www.model_liveplay.ppt.MyPPTFragment;
import com.jungan.www.model_liveplay.ppt.PPTPresenter;
import com.jungan.www.model_liveplay.ppt.quickswitchppt.QuickSwitchPPTFragment;
import com.jungan.www.model_liveplay.ppt.quickswitchppt.SwitchPPTFragmentPresenter;
import com.jungan.www.model_liveplay.pptleftmenu.PPTLeftFragment;
import com.jungan.www.model_liveplay.pptleftmenu.PPTLeftPresenter;
import com.jungan.www.model_liveplay.pptmanage.PPTManageFragment;
import com.jungan.www.model_liveplay.pptmanage.PPTManagePresenter;
import com.jungan.www.model_liveplay.quiz.QuizDialogFragment;
import com.jungan.www.model_liveplay.quiz.QuizDialogPresenter;
import com.jungan.www.model_liveplay.rightbotmenu.RightBottomMenuFragment;
import com.jungan.www.model_liveplay.rightbotmenu.RightBottomMenuPresenter;
import com.jungan.www.model_liveplay.rightmenu.RightMenuFragment;
import com.jungan.www.model_liveplay.rightmenu.RightMenuPresenter;
import com.jungan.www.model_liveplay.rollcall.RollCallDialogFragment;
import com.jungan.www.model_liveplay.rollcall.RollCallDialogPresenter;
import com.jungan.www.model_liveplay.setting.SettingDialogFragment;
import com.jungan.www.model_liveplay.setting.SettingPresenter;
import com.jungan.www.model_liveplay.share.LPShareDialog;
import com.jungan.www.model_liveplay.speakerspanel.RecorderView;
import com.jungan.www.model_liveplay.speakerspanel.SpeakerPresenter;
import com.jungan.www.model_liveplay.speakerspanel.SpeakersFragment;
import com.jungan.www.model_liveplay.speakerspanel.VideoView;
import com.jungan.www.model_liveplay.topbar.TopBarFragment;
import com.jungan.www.model_liveplay.topbar.TopBarPresenter;
import com.jungan.www.model_liveplay.users.OnlineUserDialogFragment;
import com.jungan.www.model_liveplay.users.OnlineUserPresenter;
import com.jungan.www.model_liveplay.utils.JsonObjectUtil;
...
public class LiveRoomActivity extends LiveRoomBaseActivity implements LiveRoomRouterListener {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("userNum",userNum);
        outState.putInt("userGroup",userGroup);
...
//        View anchor = findViewById(R.id.activity_live_room_center_anchor);
//        RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) anchor.getLayoutParams();
//        lp.topMargin = DisplayUtils.getScreenWidthPixels(this) * 3 / 4;
//        anchor.setLayoutParams(lp);
        ...
        if (savedInstanceState == null) {
            ...
            userGroup=getIntent().getIntExtra("userGroup",0);
            isGroup=getIntent().getBooleanExtra("isGroup",false);
            if(isGroup){
                enterUser =new LiveSDKWithUI.LiveRoomUserModel(name,
                        avatar,
                        userNum,
                        userGroup); //(IUserModel) getIntent().getSerializableExtra("user");
            }else {
                enterUser =new LiveSDKWithUI.LiveRoomUserModel(name,
                        avatar,
                        userNum
                        ); //(IUserModel) getIntent().getSerializableExtra("user");
            }
            ...
            userNum=savedInstanceState.getString("userNum");
            userGroup=savedInstanceState.getInt("userGroup");
...
//                        getLiveRoom().getLivePlayer().setCommunicationMode(isCommunication);
    ...
    public void showNoSpeakers() {
        ...
        if (lp.getRules()[RelativeLayout.BELOW] == R.id.activity_live_room_center_anchor) {
            return;
        }
