...
public class UILKit {
    ...
    private UILKit(Context context) {
        ...
        picOptions = new DisplayImageOptions.Builder()
                ...
                .cacheOnDisk(false).
                        cacheInMemory(false)
                .showImageOnLoading(R.drawable.public_difficult) // 加载过程中的显示图片
                .showImageForEmptyUri(R.drawable.public_difficult) // 路径为空时显示的图片
                .showImageOnFail(R.drawable.public_difficult) // 加载失败显示的图片
