...
public class MyRatingBar extends LinearLayout {
    ...
    public MyRatingBar(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.Main_RatingBar);
        starImageSize = mTypedArray.getDimension(R.styleable.Main_RatingBar_main_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.Main_RatingBar_main_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.Main_RatingBar_main_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.Main_RatingBar_main_stepSize, 1));
        starCount = mTypedArray.getInteger(R.styleable.Main_RatingBar_main_starCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.Main_RatingBar_main_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.Main_RatingBar_main_starFill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.Main_RatingBar_main_starHalf);
        mClickable = mTypedArray.getBoolean(R.styleable.Main_RatingBar_main_clickable, true);
        mTypedArray.recycle();
